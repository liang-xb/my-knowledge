...
#### 在 src/views/emp/index.vue 中增加如下代码
...
<br/>
<img src="./新增员工-1.png" style="width:800px;margin:0 auto;"/>
...
#### （1）在 emp.js 中定义新增函数 addApi，并在 emp/index.vue 中引入该函数
...
#### （4）每次点击新增员工，上一次的信息需要清空，优化 emp/index.vue 中的 addEmp 函数
...
#### （1）在 src/views/emp/index.vue 中的 &lt;script&gt; &lt;/script&gt; 中添加表单校验规则
