 ...
 * ─────────────────────────────────────────────────────────── */
const tips = [
  { icon: '☕', title: 'TIP 1', text: 'Java 之路无捷径，踏实敲好每一行代码，每一天都是积累，静待厚积薄发', color: '#3478d9' },
  { icon: '💪', title: 'TIP 2', text: '不怕基础弱，就怕不动手。每一个优秀的后端工程师，都曾是迷茫的初学者', color: '#8b5cf6' },
  { icon: '🚀', title: 'TIP 3', text: '保持好奇心，拥抱新技术，但永远不要忘记：深度比广度更值得追求', color: '#f59e0b' },
]
